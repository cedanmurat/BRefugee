...
public class Nationalism extends Fragment {
    @BindView(R.id.voices_image_n)
    ImageView voicesImage;
    @BindView(R.id.nameVideo_n)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       final View view=inflater.inflate(R.layout.nationalism,null);
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        if(e!=null){
                            ...
                            try {
                                ...
                                JSONObject voicesVideo=nationalism.getJSONObject("voicesVideo");
                                ...
                                JSONArray jsonArrayCase=nationalism.optJSONArray("caseStudyVideo");
                                ...
                                JSONArray jsonArrayHow=nationalism.optJSONArray("howToMediateVideo");
